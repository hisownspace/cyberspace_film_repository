...
def seed_films(actors, genres):
  ...
  film1 = Film(
    ...
    """,
    cast = [actor1, actor2],
    image_url = 'https://m.media-amazon.com/images/M/MV5BNDg3MDM5NTI0MF5BMl5BanBnXkFtZTcwNDY0NDk0NA@@._V1_.jpg',
    genre = drama
  )
  ...
  film2 = Film(
    ...
    image_url = 'https://m.media-amazon.com/images/M/MV5BNjgwMmI4YzUtZGI2Mi00M2MwLWIyMmMtZWYzMWZmNzAyNmYwXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg',
    genre = sci_fi
  )
  ...
  film3 = Film(
    ...
    image_url = "https://m.media-amazon.com/images/M/MV5BNTQ5OTUwYjQtYmM5Ni00YTY5LWFiOWEtYTg1MTg2Y2NmY2JhXkEyXkFqcGdeQXVyMTAzNjk5MDI4._V1_.jpg",
    genre = drama
  )
  ...
  film4 = Film(
    ...
    image_url = "https://m.media-amazon.com/images/M/MV5BZTQwYThhZTYtZTQ3MC00NDQ0LWFkZGMtMzdiMTU3OGJiYTY0XkEyXkFqcGdeQXVyODE5NzE3OTE@._V1_.jpg",
    genre = western
  )
  ...
  okja = Film(
    ...
    image_url = "https://m.media-amazon.com/images/M/MV5BMjQxMTcxNDgxN15BMl5BanBnXkFtZTgwOTczNTIzMjI@._V1_FMjpg_UX509_.jpg",
    genre = drama 
  )
